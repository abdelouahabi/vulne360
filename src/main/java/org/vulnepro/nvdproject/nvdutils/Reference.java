...
public class Reference {
    ...
    public Reference withTags(List<String> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((this.source == rhs.source)||((this.source!= null)&&this.source.equals(rhs.source)))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.url == rhs.url)||((this.url!= null)&&this.url.equals(rhs.url))))&&((this.tags == rhs.tags)||((this.tags!= null)&&this.tags.equals(rhs.tags))));
    }
